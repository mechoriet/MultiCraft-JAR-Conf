...
wget -N -P ./jar https://git.diviwork.nl/mechoriet/multicraft-conf/raw/master/minecraft/paperspigot/paperspigot-1.12.2.jar.conf
chown minecraft:minecraft ./jar/paperspigot-1.12.2.jar.conf

wget -N -P ./jar https://git.diviwork.nl/mechoriet/multicraft-conf/raw/master/minecraft/bungeecord/bugeecord-1.12.2.jar.conf
chown minecraft:minecraft ./jar/bugeecord-1.12.2.jar.conf

wget -N -P ./jar https://git.diviwork.nl/mechoriet/multicraft-conf/raw/master/minecraft/spigot/spigot-1.12.2.jar.conf
chown minecraft:minecraft ./jar/spigot-1.12.2.jar.conf

wget -N -P ./jar https://git.diviwork.nl/mechoriet/multicraft-conf/raw/master/minecraft/spigot/spigot-1.13-pre7.jar.conf
